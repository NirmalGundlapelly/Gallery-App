...
class Gallery extends Component {
  ...
  changeImageUrl = id => {
    const clickedObject = imagesList.filter(eachItem => eachItem.id === id)

    this.setState({activeImage: clickedObject[0]})
  }
    ...
    return (
      <div className="bgContainer">
        <div className="contentContainer">
          <img alt={imageAltText} className="activeImage" src={imageUrl} />
